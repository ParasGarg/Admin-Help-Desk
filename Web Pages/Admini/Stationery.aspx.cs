...
public partial class Web_Pages_Admini_Stationery : System.Web.UI.Page
{
    ...
    protected void gv_stationery_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        gv_stationery.PageIndex = e.NewPageIndex;
        BindGrid();
    }

    protected void BindGrid()
    {
        SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM tbl_stationery", con);
        DataSet ds = new DataSet();
        da.Fill(ds);
        gv_stationery.DataSource = ds;

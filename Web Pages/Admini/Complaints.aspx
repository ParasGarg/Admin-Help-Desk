<%@ Page Title="" Language="C#" MasterPageFile="~/Master Pages/Admin.master" AutoEventWireup="true" CodeFile="Complaints.aspx.cs" Inherits="Web_Pages_Admini_Complaints" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <br /><br />
    ...
    <table class="style1">
        ...
        <tr>
            <td>
                <asp:GridView ID="gv_complaints" runat="server" AllowSorting="True"  AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" 
                    GridLines="None" TabIndex="-1" style="text-align: center" Width="1060px" AllowPaging="True" onpageindexchanging="gv_complaints_PageIndexChanging">
